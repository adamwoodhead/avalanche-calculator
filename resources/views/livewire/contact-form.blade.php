        ...
        <div class="w-full sm:mx-64 bg-white rounded-md p-4" x-show="!open">
            ...
            <form class="w-full mt-4 flex flex-col space-y-4" wire:submit.prevent="submit">
                ...
                <div class="w-full">
                    ...
                    <input wire:model="subject" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 focus:outline-none focus:bg-white focus:border-gray-500" type="text">
