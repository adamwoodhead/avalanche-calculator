<x-app-layout>
    <div class="bg-white p-4">
        ...
        <div class="flex flex-col space-y-2">
            <p>Avalanche Calculator (formerly Snowball My Debt) was built originally as a extra-learning project, with zero profits in mind - this has stayed the same.</p>
